...
//it will display this level
    ...
    public void Lift_Weights(View view) {
        mediaPlayer = new MediaPlayer();
        MediaPlayer midiFileMediaPlayer = MediaPlayer.create(this, R.raw.liftweights);
        midiFileMediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mediaPlayer) {
                mediaPlayer.release();
    ...
    public void Ride_A_Bike(View view) {
        mediaPlayer = new MediaPlayer();
        MediaPlayer midiFileMediaPlayer = MediaPlayer.create(this, R.raw.rideabike);
        midiFileMediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mediaPlayer) {
                mediaPlayer.release();
    ...
    public void Bird(View view) {
        mediaPlayer = new MediaPlayer();
        MediaPlayer midiFileMediaPlayer = MediaPlayer.create(this, R.raw.bird);
        midiFileMediaPlayer.setOnCompletionListener(new MediaPlayer.OnCompletionListener() {
            @Override
            public void onCompletion(MediaPlayer mediaPlayer) {
                mediaPlayer.release();
